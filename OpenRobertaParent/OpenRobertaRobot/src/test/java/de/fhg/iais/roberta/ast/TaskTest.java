    ...
    public void mainTask() throws Exception {
        String a =
            "BlockAST [project=[[Location [x=1, y=7], MainTask [\n"
                ...
                + "exprStmt VarDeclaration [ARRAY_COLOUR, item7, ListCreate [COLOR, ColorConst [#b30006, RED], ColorConst [#000000, BLACK], ColorConst [#585858, NONE]], true, true]\n"
                + "exprStmt VarDeclaration [COLOR, item8, ColorConst [#585858, NONE], false, true]]]]]";
